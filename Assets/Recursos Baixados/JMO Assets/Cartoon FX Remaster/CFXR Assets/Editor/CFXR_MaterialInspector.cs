...
namespace CartoonFX
{
    public class MaterialInspector : ShaderGUI
    {
                ...
                if (materials.Count > 0 && materials[0].shader != null)
                {
                    ...
                    foreach (var l in lines)
                    {
                        ...
                        if (insideProperties)
                        {
                            ...
                            {
                                string command = line.Substring(kGuiCommandPrefix.Length)
                                    .TrimStart();
                                //space
                                ...
                                {
                                    var expr = command.Substring(
                                        command.LastIndexOf(kGC_IfKeyword)
                                            + kGC_IfKeyword.Length
                                            + 1
                                    );
                                    AddGUICommand(
                                        propertyCount,
                                ...
                                {
                                    var expr = command.Substring(
                                        command.LastIndexOf(kGC_IfProperty)
                                            + kGC_IfProperty.Length
                                            + 1
                                    );
                                    AddGUICommand(
                                        propertyCount,
                                ...
                                else if (command.StartsWith(kGC_HelpBox))
                                {
                                    ...
                                    var cmd = command
                                        .Substring(
                                            command.LastIndexOf(kGC_HelpBox)
                                                + kGC_HelpBox.Length
                                                + 1
                                        )
                                        .Split(
                                ...
                                {
                                    var label = command.Substring(
                                        command.LastIndexOf(kGC_Label) + kGC_Label.Length + 1
                                    );
        ...
        protected virtual void DisplayProperty(
    ...
    internal class MaterialKeywordEnumNoPrefixDrawer : MaterialPropertyDrawer
    {
        ...
        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1)
            : this(new[] { lbl1 }, new[] { kw1 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2)
            : this(new[] { lbl1, lbl2 }, new[] { kw1, kw2 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(
            string lbl1,
            string kw1,
            string lbl2,
            string kw2,
            ...
            : this(new[] { lbl1, lbl2, lbl3 }, new[] { kw1, kw2, kw3 }) { }
        ...
        public MaterialKeywordEnumNoPrefixDrawer(
            ...
            : this(new[] { lbl1, lbl2, lbl3, lbl4 }, new[] { kw1, kw2, kw3, kw4 }) { }
        ...
        public MaterialKeywordEnumNoPrefixDrawer(
            ...
            : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5 }, new[] { kw1, kw2, kw3, kw4, kw5 }) { }
        ...
        public MaterialKeywordEnumNoPrefixDrawer(
            ...
            : this(
                new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6 },
                new[] { kw1, kw2, kw3, kw4, kw5, kw6 }
            ) { }
    ...
    internal class GC_IfKeyword : GUICommand
    {
        ...
        public override void OnGUI()
        {
            bool show = ExpressionParser.EvaluateExpression(
                expression,
                (string s) =>
                {
            ...
            foreach (var m in materials)
            {
                ...
                )
                {
                    ...
                    switch (component)
                    {
                        ...
                        default:
                            Debug.LogError(
                                "Invalid component for vector property: '" + property + "'"
                            );
                            break;
                    }
                }
