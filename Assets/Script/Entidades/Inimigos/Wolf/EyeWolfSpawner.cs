...
{
  [Header("Lobos deste Spawner")]
    [SerializeField] private GameObject[] _wolves;
    ...
    [SerializeField] private bool _spawnAutomatically = true;

    [Header("Performance")]
    [SerializeField] private float _distanceCheckInterval = 0.25f;
    ...
    {
        _spawnDistanceSqr =
            _spawnDistance * _spawnDistance;

        _despawnDistanceSqr =
            _despawnDistance * _despawnDistance;
    ...
    private void Update()
    {
        ...
        _nextDistanceCheck =
            Time.time + _distanceCheckInterval;
    ...
    private void ActivateWolves()
    {
        ...
        Debug.Log(
            $"[EyeWolfSpawner] Lobos ativados: {name}"
        );
    }
    ...
    private void DeactivateWolves()
    {
        ...
        Debug.Log(
            $"[EyeWolfSpawner] Lobos desativados: {name}"
        );
    }
