...
public class ConfigPlayer : ScriptableObject
{
    ...
    [Header("Regeneração")]
    [SerializeField] private bool habilitarRegeneracao;
    [SerializeField] private float intervaloRegeneracao;

    [Header("Combate")]
    [SerializeField] private float cooldownCombate;
    [SerializeField] private float cooldownDano;
    ...
    [SerializeField] private float duracaoDash;
    ...
    [SerializeField] private QualityTier multiplicadorVelocidadeParede;
