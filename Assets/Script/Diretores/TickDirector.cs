...
public partial class TickDirector : MonoBehaviour
{
	    ...
	    public static TickDirector Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindAnyObjectByType<TickDirector>() ??
	...
	[HideInInspector] public UnityEvent<uint> OnTick = new();
	[HideInInspector] public UnityEvent<uint> OnFiveTick = new();
	[HideInInspector] public UnityEvent<uint> OnTenTick = new();
	[HideInInspector] public UnityEvent<uint> OnFifteenTick = new();
	[HideInInspector] public UnityEvent<uint> OnSecond = new();
